		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "nodes.0.data.extract_vars.#", "2"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "nodes.0.data.extract_vars.0.name", "name1"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "nodes.0.data.extract_vars.0.type", "type1"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "nodes.0.data.extract_vars.0.description", "description1"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "nodes.0.data.extract_vars.0.increase_spelling_precision", "true"),
					...
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "edges.0.data.conditions.#", "1"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "edges.0.data.conditions.0.field", "expected_annual_salary"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "edges.0.data.conditions.0.value", "500000"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "edges.0.data.conditions.0.is_group", "false"),
					resource.TestCheckResourceAttr("data.bland_conversational_pathway.pathway", "edges.0.data.conditions.0.operator", "less than"),
